...
class _EditNoteState extends State<EditNote> {
  ...
  void initState() {
    ...
    final noteData = allNotes.firstWhere(
      (n) => n['key'] == widget.index,
      orElse: () => {'folder': "General"},
    );
  ...
  void _updateNote() {
    ...
    context
        .read<NotesProvider>()
        .editNote(widget.index, title, contentJson, timestamp);
    context
        .read<NotesProvider>()
        .moveNoteToFolder(widget.index, _selectedCategory);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            const Text('Edit Note', style: TextStyle(fontWeight: FontWeight.bold)),
